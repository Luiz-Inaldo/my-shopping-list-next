  ...
  return (
    ...
    >
      ...
      <div className="mb-3.5">
        ...
        <div className="relative h-2.5 w-full overflow-hidden rounded-sketch-progress border-2 border-sketch-border bg-sketch-muted">
          <div
            className={cn(
      ...
      <div className="flex items-center gap-2.5">
        ...
        <DeletePurchase purchase={item} mode={deleteMode} />
      </div>
