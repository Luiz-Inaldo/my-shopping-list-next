...
const ShoppingList = ({ listname }: { listname: string | undefined }) => {
    ...
    return (
      <>
        ...
        <Fade triggerOnce>
          <div className="rounded-lg bg-app-container p-2 shadow-lg border">
            <div
                ...
                {(handleClick, open) => {
                  return (
                    <div className="w-full rounded shadow">
                      <div
                        className={`relative z-[2] ${category.backgroundColor} flex px-3 py-2 items-center rounded justify-between text-gray-700`}
                      >
                        <div className="relative flex items-center gap-3">
                          <div
                            className={`absolute -top-3.5 -left-6 w-[56px] h-[56px] rounded-full flex items-center justify-center ${category.backgroundColor}`}
                          >
                            <category.icon />
                          </div>
                                    ...
                                    >
                                      <div className="flex items-center">
                                        ...
                                        >
                                          ...
                                          <span
                                            title={item.name}
                                            className={`max-w-60 text-ellipsis overflow-hidden whitespace-nowrap ${item.checked && "line-through italic"}`}
                                          >
                                            {item.name}
                                          </span>
                                        </label>
