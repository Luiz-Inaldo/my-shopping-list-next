...
const Main = () => {
  ...
  return (
    <React.Fragment>
      <main
        className={`flex flex-col items-center gap-5 px-5 py-3 ${
          showFooter ? "mb-96" : "mb-10"
        }`}
      >
        ...
        <h2 className="text-2xl text-subtitle font-bold">Categorias</h2>
        ...
        {CATEGORIES.map((category) => {
          ...
          return (
            <div
              key={category.name}
              className="flex flex-col gap-4 w-full rounded p-2 bg-snow"
            >
                  ...
                  {products.length > 0 ? (
                    <React.Fragment>
                      {products.map((item) => (
                        <div
                          key={item.name}
                          className="flex flex-col gap-4 ml-5 p-1 rounded"
                        >
                          <div
                          ...
                          >
                            <div className="flex items-center">
                              ...
                              <div className="relative w-6 h-6 rounded-full flex items-center justify-center cursor-pointer">
                                <EllipsisVertical
                                  size={16}
      ...
      <footer
        className={`fixed bottom-0 w-[430px] ${
